    ...
    public partial class initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Pokemonİd = table.Column<int>(type: "int", nullable: false),
                    Categoryİd = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_PokemonCategories", x => new { x.Pokemonİd, x.Categoryİd });
                    table.ForeignKey(
                        name: "FK_PokemonCategories_Categories_Categoryİd",
                        column: x => x.Categoryİd,
                        principalTable: "Categories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PokemonCategories_Pokemons_Pokemonİd",
                        column: x => x.Pokemonİd,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PokemonCategories_Categoryİd",
